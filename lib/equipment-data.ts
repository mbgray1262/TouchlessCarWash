...
export const EQUIPMENT_MODEL_DATA: EquipmentModelData[] = [
  ...
  { slug: 'razor-double-barrel', name: 'Razor Double Barrel', brandSlug: 'washworld', description: 'The WashWorld Razor Double Barrel is a dual-spinner configuration of the Razor platform that uses two high-pressure rotating nozzle arms instead of one, dramatically increasing water coverage and cleaning power per pass. The twin-spinner design delivers faster, more thorough touchless cleaning, making it well suited to busy locations that need to move vehicles through quickly without sacrificing wash quality.', keyFeatures: ['Twin rotating high-pressure spinner arms for double the cleaning coverage', 'Faster cycle times for higher throughput at busy sites', 'Proven Razor reliability and stainless steel construction', 'Fully touchless — no brushes or cloth contact the vehicle'], bestFor: 'High-traffic locations that want maximum touchless cleaning power and faster wash cycles.', seoTitle: 'WashWorld Razor Double Barrel Car Wash Locations', seoDescription: 'Find touchless car washes using the WashWorld Razor Double Barrel dual-spinner system.' },
  ...
  { slug: 'saber', name: 'Saber', brandSlug: 'belanger', description: 'The Belanger Saber is a touch-free in-bay automatic car wash that cleans using high-pressure water and detergents delivered through an overhead arm, with no brushes or cloth touching the vehicle. Known for its compact footprint and dependable operation, the Saber is a popular choice for convenience stores, gas stations, and standalone bays that want a straightforward, low-maintenance touchless wash.', keyFeatures: ['Fully touch-free cleaning — no brushes or cloth contact the vehicle', 'Compact footprint that fits a standard wash bay', 'High-pressure water and detergent delivery via overhead arm', 'Low-maintenance design suited to c-store and gas-station sites'], bestFor: 'Convenience stores and standalone bays wanting a simple, reliable touch-free in-bay automatic.', seoTitle: 'Belanger Saber Car Wash Locations', seoDescription: 'Find touchless car washes using the Belanger Saber touch-free in-bay automatic system.' },
  ...
  { slug: 'flex-5', name: 'FLEX 5', brandSlug: 'istobal', description: 'The Istobal FLEX 5 is a touch-free in-bay automatic car wash engineered for flexible, high-quality cleaning with European water- and energy-efficient design. It applies high-pressure water and staged detergents through a moving gantry to clean the entire vehicle without contact, and its configurable wash programs let operators offer multiple wash levels from a single machine.', keyFeatures: ['Fully touch-free gantry cleaning with no brushes or cloth', 'Configurable multi-level wash programs from one machine', 'European water- and energy-efficient engineering', 'Suited to a wide range of vehicle sizes'], bestFor: 'Operators wanting a flexible, efficient touch-free in-bay automatic with multiple wash tiers.', seoTitle: 'Istobal FLEX 5 Car Wash Locations', seoDescription: 'Find touchless car washes using the Istobal FLEX 5 touch-free in-bay automatic system.' },
  ...
  { slug: 'iq-2-0-genius-series', name: 'IQ 2.0 Genius Series', brandSlug: 'ds', description: 'The D&S IQ 2.0 Genius Series is the smart, premium tier of the IQ 2.0 touch-free in-bay automatic platform, adding intelligent vehicle-profiling sensors and programmable wash packages on top of the proven IQ 2.0 cleaning system. The Genius controls fine-tune water pressure and chemical application to each vehicle and wash level, helping operators offer tiered pricing while keeping the wash fully touchless.', keyFeatures: ['Smart vehicle profiling for optimized, vehicle-specific cleaning', 'Programmable tiered wash packages for premium pricing', 'Fully touch-free high-pressure cleaning — no contact with the vehicle', 'Builds on the reliable D&S IQ 2.0 in-bay automatic platform'], bestFor: 'Operators who want a smart, touch-free in-bay system with tiered wash menus and per-vehicle optimization.', seoTitle: 'D&S IQ 2.0 Genius Series Car Wash Locations', seoDescription: 'Find touchless car washes using the D&S IQ 2.0 Genius Series smart in-bay automatic system.' },
  ...
  { slug: 'opti-8000', name: 'Opti 8000', brandSlug: 'karcher', description: 'The Kärcher Opti 8000 is a touch-free in-bay automatic car wash that uses high-pressure water jets and precisely metered detergents to clean vehicles without any brushes or cloth. Built with Kärcher\'s German engineering, it pairs efficient water management with strong, consistent cleaning, and is one of the more widely deployed touch-free systems at U.S. convenience-store and gas-station washes.', keyFeatures: ['Fully touch-free high-pressure cleaning — no brushes or cloth', 'German-engineered reliability and efficient water management', 'Metered detergent application for consistent results', 'Proven at high-volume c-store and gas-station locations'], bestFor: 'C-store and gas-station operators wanting a dependable, efficient touch-free in-bay automatic.', seoTitle: 'Kärcher Opti 8000 Car Wash Locations', seoDescription: 'Find touchless car washes using the Kärcher Opti 8000 touch-free in-bay automatic system.' },
