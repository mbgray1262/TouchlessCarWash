...
export const METRO_AREAS: MetroArea[] = [
  ...
  { name: 'Tri-Cities', displayName: 'Tri-Cities, WA', slug: 'tri-cities', lat: 46.2112, lng: -119.1372, radiusMiles: 25, states: ['WA'], region: 'West' },
  ...
  { name: 'Haverhill', displayName: 'Haverhill-Salem, MA-NH', slug: 'haverhill', lat: 42.8043, lng: -71.2939, radiusMiles: 20, states: ['MA', 'NH'], region: 'Northeast' },
