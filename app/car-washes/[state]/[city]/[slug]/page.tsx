...
const ListingMap = dynamic(() => import('@/components/ListingMap'), {
  ssr: false,
  loading: () => <div className="h-[350px] bg-gray-100 animate-pulse rounded-xl" />,
});
...
export async function generateMetadata({ params }: ListingPageProps): Promise<Metadata> {
  ...
  const canonicalUrl = `${SITE_URL}/car-washes/${params.state}/${params.city}/${params.slug}`;
...
function NearbyListingCard({ nearby, stateSlug }: { nearby: Listing; stateSlug: string }) {
  ...
  return (
    <Link
      href={`/car-washes/${stateSlug}/${citySlug}/${nearby.slug}`}
...
export default async function ListingDetailPage({ params }: ListingPageProps) {
  ...
  const breadcrumbItems = [
    ...
    { name: stateName, url: `${SITE_URL}/car-washes/${params.state}` },
    { name: cityName, url: `${SITE_URL}/car-washes/${params.state}/${params.city}` },
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="relative bg-[#0F2744]">
          ...
          <div className="absolute inset-0 flex flex-col justify-end">
            <div className="container mx-auto px-4 max-w-5xl pb-8">
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-sm text-white/50 mb-4 flex-wrap">
                ...
                <ChevronRight className="w-3.5 h-3.5 shrink-0" />
                <Link href={`/car-washes/${params.state}/${params.city}`} className="hover:text-white transition-colors">{cityName}</Link>
                <ChevronRight className="w-3.5 h-3.5 shrink-0" />
        ...
        <div className="container mx-auto px-4 max-w-5xl py-8 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-5">
              ...
              <Button asChild variant="outline" className="w-full">
                <Link href={`/car-washes/${params.state}/${params.city}`}>
          ...
          {nearbyListings.length > 0 && (
            <div>
              <div className="flex items-center justify-between mb-5">
                ...
                <Link
                  href={`/car-washes/${params.state}/${params.city}`}
          ...
          {lastVerified && (
            <div className="pt-6 border-t border-gray-200 flex items-center gap-2 text-xs text-gray-400">
