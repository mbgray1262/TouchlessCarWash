...
const FAQ = [
  ...
  { q: 'What are the disadvantages of a touchless car wash?', a: 'The main trade-off is cleaning power. Because no brushes agitate the surface, a touchless wash can leave heavy, caked-on dirt, bird droppings, or bug residue behind in a single pass — a pre-soak or second pass usually solves it. Touchless washes also lean on stronger detergents and high water pressure, often cost a little more than a basic brush tunnel, and typically skip hand-drying, so dry your car promptly to avoid water spots. The upside is what makes them worth it: no spinning brushes means no swirl marks or micro-scratches.' },
  { q: 'Are touchless car washes better for your car than brush washes?', a: 'For your paint, yes. Brush and cloth washes physically drag reclaimed grit across your finish, which is how swirl marks and micro-scratches build up over time. A touchless wash never touches the car, so that risk disappears — which is why owners of new, luxury, ceramic-coated, and PPF-wrapped vehicles favor them. Brush washes can scrub off stubborn dirt more aggressively, but for routine washing and long-term finish protection, touchless is the gentler choice.' },
  { q: 'Do touchless car washes clean as well as brush car washes?', a: 'For everyday road grime, dust, and salt, yes — high-pressure water and modern detergents remove the vast majority of dirt without contact. Where they are weaker is heavy, baked-on messes like thick mud or dried bug splatter, which brushes physically scrub away. In our analysis of thousands of customer reviews, most cleaning complaints are about these edge cases, not routine washes — and a pre-soak or second pass typically closes the gap.' },
