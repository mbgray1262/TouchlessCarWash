...
const faqItems: { question: string; answer: React.ReactNode; schemaAnswer?: string }[] = [
  ...
  },
  {
    ...
    answer: 'A touchless car wash is one type of automatic car wash. "Automatic car wash" is a broad term that includes any wash where you stay in your vehicle while the equipment does the work — this covers both in-bay automatic touchless washes (which use only high-pressure water and chemistry, no brushes) and tunnel/soft-touch automatic washes (which use spinning brushes, foam pads, or cloth strips that physically touch your car). Every listing in this touchless directory is an automatic touchless car wash — meaning it cleans your vehicle automatically without any brush or cloth contact. ' + (SELF_SERVE_LIVE ? 'We exclude soft-touch tunnels; driver-controlled self-serve wand bays are covered in our separate self-serve car wash section.' : 'We exclude soft-touch tunnels and self-serve wand bays so you only see verified no-touch automatic locations.'),
  },
  {
