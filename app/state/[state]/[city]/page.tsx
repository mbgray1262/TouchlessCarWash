...
export async function generateMetadata({ params }: CityPageProps): Promise<Metadata> {
  ...
  const metaDescription = cityDesc
    ...
    : `Find ${listings.length} touchless, brushless & automatic car washes in ${cityName}, ${stateName}.${ratingSnippet} Verified locations with ratings, hours, and directions.`;
