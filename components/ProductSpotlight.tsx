...
export function ProductSpotlight({
  ...
  return (
    ...
    >
    <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-center rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-blue-50/40 p-5 hover:border-[#22C55E] hover:shadow-md transition-all">
      <a
        href={affiliateUrl(product)}
        target="_blank"
        rel="noopener noreferrer sponsored nofollow"
        className="group flex flex-col sm:flex-row gap-5 items-start sm:items-center flex-1 min-w-0"
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className="font-bold text-[#0F2744] mb-1.5 leading-snug group-hover:text-[#22C55E] transition-colors">
            {product.name}
          </h3>
      ...
      <BuyButtons product={product} className="shrink-0 w-full sm:w-auto" />
    </div>
    <Link
      href="/shop"
